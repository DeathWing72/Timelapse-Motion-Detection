...
class WindowManager 
{
    ...
    public WindowManager(BufferedImage refImage, BufferedImage comparisonImage) throws SsimException 
    {
    ...
    private List<Window> getSsimWindowsForImage(BufferedImage image, int numXWindows, int numYWindows)
    {
    ...
    public static class WindowContainer implements Iterable<Pair<Window>>
    {
        ...
        private WindowContainer(Collection<Window> primary, Collection<Window> secondary) throws SsimException
        {
